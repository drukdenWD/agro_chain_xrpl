...
// this is the landing page after successfully logging into my website.
                ...
                <div className="col-md-8">
                  <div className="container">
                    <div className="carousel-caption text-start">
                      ...
                      <p>Have XRPL secret key and wants to upload crop details? Click <b>Know More</b></p>
                      <p><a className="btn btn-lg btn-primary" href="info">Know More</a></p>
                    </div>
                  </div>
                </div>
